...
public enum FileSystemAction implements ResourceId {
	download, rename, copy, copyHere, move, delete, upload, details, create_folder, download_as_zip, set_description, remove_description, get_item_permissions, view, publicLink;
