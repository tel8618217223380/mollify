...
public class JsUtilTest extends GWTTestCase {
	...
	public void testAsJsonString() {
		...
		o.put("a", JsFile.create("a", "", "file A", "path a", "p", "ext", 123));
		o.put("b", JsUtil.asJsArray(JsFile.class,
				JsFile.create("b", "", "file B", "path b", "p", "ext", 123),
				JsFile.create("c", "", "file C", "path c", "p", "ext", 123)));
		assertEquals(
