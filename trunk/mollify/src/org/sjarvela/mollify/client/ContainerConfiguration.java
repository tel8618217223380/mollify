...
public class ContainerConfiguration extends AbstractGinModule {
	...
	ServiceEnvironment getEnvironment(UrlResolver urlResolver,
		...
		ServiceEnvironment env = new PhpServiceEnvironment();// GWT.create(ServiceEnvironment.class);
	...
	// @Provides
	// @Singleton
	// FileUploadDialogFactory getFileUploadDialogFactory(ServiceEnvironment
	// env,
