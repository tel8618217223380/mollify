...
public class UploadBuilder {
	...
	public void clearSettings() {
		...
		setPostParams(JavaScriptObject.createObject());
	}
	...
	public native void setFlashURL(String url) /*-{
	...
	public native void addPostParam(String name, String value) /*-{
		this.@org.swfupload.client.UploadBuilder::settings['post_params'][name] = value;
	}-*/;
	...
	public native void setDialogStartHandler(DialogStartHandler handler) /*-{
		this.@org.swfupload.client.UploadBuilder::settings['file_dialog_start_handler'] = function() {
		@org.swfupload.client.UploadBuilder::fireDialogStartEvent(Lorg/swfupload/client/event/DialogStartHandler;)(handler);
		};
	}-*/;
