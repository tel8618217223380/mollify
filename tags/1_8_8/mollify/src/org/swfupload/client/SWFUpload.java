...
public final class SWFUpload extends JavaScriptObject {
	...
	public static interface QueueError {
	...
	public static interface UploadError {
	...
	public static enum ButtonCursor {
		ARROW(-1), HAND(-2);
	 ...
	 * <p>
	 * The text can be styled using HTML <a href="http://livedocs.adobe.com/flash/9.0/ActionScriptLangRefV3/flash/text/TextField.html#htmlText"
	 ...
	 * formatted according to the <a href="http://livedocs.adobe.com/flash/9.0/ActionScriptLangRefV3/flash/text/StyleSheet.html"
