/*
 * Copyright 2008 Folke Behrens <messias@gmail.com>
 * 
...
public final class RegExp extends JavaScriptObject {
	...
	public static final class Result extends JavaScriptObject {
		...
		/**
		 * Depending on the global ('g') flag this either returns a 0-indexed
		 * match or 1-indexed submatch.
		 * 
		 * @param num
		...
		/**
		 * @return The index of the match. Always <code>0</code> in global
		 *         matching mode.
		 */
	 ...
	 * @param pattern
	 * @param flags
	 *            Any combination of <code>'g'</code>, <code>'m'</code>, and
