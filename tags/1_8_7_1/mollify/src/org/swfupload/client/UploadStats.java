...
public final class UploadStats extends JavaScriptObject {
	...
	/**
	 * Get the number of files that have uploaded successfully (uploads where
	 * the uploadSuccess event was generated)
	 * 
	 * @return the number of files that have uploaded successfully (uploads
	 *         where the uploadSuccess event was generated)
	 */
	 ...
	 * 
	 * @return the number of files that have had errors (excluding cancelled
	 *         files)
	 */
